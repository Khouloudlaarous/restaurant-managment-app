...
#main {
  background: linear-gradient(to bottom, #bd7dff, #361f88);
  width: 100%;
  height: 110vh;
  display: flex;
...
span {
  ...
  height: 2px;
  display: block;
  background-image: linear-gradient(to right, #fbf9fe, transparent);
  margin: 25px;
  margin-bottom: 50px;
